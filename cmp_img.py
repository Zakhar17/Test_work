...
import os
import argparse #required to make the program
                # callable with arguments in console
...
def image_comparison(folder):
    ...
    """First part of the program finds identical and modified images"""
        ...
        for compared in Images:
            if compared != img:
                ...
                if d == 0:
                    ...
                    ident_and_modif_pairs.add((img[0], compared[0]))
                elif 1 <= d <= 5:
    ...
    """Second part of the program finds similar images"""
    ...
    def find_similar(folder):
        ...
        def find_kp(image, radius=3, N=12, t=90):
            """Finds image key points with FAST method"""
        ...
        print('\nEnd! All unique pairs of similar images are found!')

    print("\n Now algorithm will search for similar photos")
    print("Be aware that it may take time until \n key points are found on all images")
    print("Photos of big size slower the algorithm. \nIn new versions algorithm speed will imminently improve!\n")
